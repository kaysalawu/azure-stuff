...
- [Testing](#testing)
  ...
  - [7. VM Configuration files](#7-vm-configuration-files)
- [Cleanup](#cleanup)
...
vm.branch1.corp - 10.10.0.5 -OK 5.812 ms
vm.hub1.az.corp - 10.11.0.5 -OK 5.523 ms
vm.spoke1.az.corp - 10.1.0.5 -OK 0.029 ms
vm.spoke2.az.corp - 10.2.0.5 -OK 5.366 ms
```
...
200 (0.030842s) - 10.10.0.5 - vm.branch1.corp
200 (0.023403s) - 10.11.0.5 - vm.hub1.az.corp
200 (0.020256s) - 10.11.4.4 - pep.hub1.az.corp
[ 1834.729303] cloud-init[1510]: 10.1.0.5 - - [21/Jan/2023 11:21:27] "GET / HTTP/1.1" 200 -
200 (0.016819s) - 10.1.0.5 - vm.spoke1.az.corp
200 (0.048311s) - 10.2.0.5 - vm.spoke2.az.corp
000 (2.000521s) -  - vm.spoke3.az.corp
```
...
Sample output
```sh
azureuser@VwanS1-spoke1-vm:~$ curl pep.hub1.az.corp
{
  "headers": {
    "Accept": "*/*",
...
### 7. VM Configuration files

You can view the startup files used to configure the virtual machines.
