...
peer 20.50.234.151
address 20.50.234.151
pre-shared-key changeme
peer 20.50.236.85
address 20.50.236.85
pre-shared-key changeme
!
crypto ikev2 profile AZURE-IKE-PROPOSAL
match address local 10.10.1.9
match identity remote address 20.50.234.151 255.255.255.255
match identity remote address 20.50.236.85 255.255.255.255
...
tunnel destination 20.50.234.151
...
ip tcp adjust-mss 1350
tunnel source 10.10.1.9
tunnel destination 20.50.236.85
tunnel protection ipsec profile AZURE-IPSEC-PROFILE
!
interface Loopback0
