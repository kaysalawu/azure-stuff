...
peer 20.166.136.216
address 20.166.136.216
pre-shared-key changeme
peer 20.166.136.114
address 20.166.136.114
pre-shared-key changeme
!
crypto ikev2 profile AZURE-IKE-PROPOSAL
match address local 10.30.1.9
match identity remote address 20.166.136.216 255.255.255.255
match identity remote address 20.166.136.114 255.255.255.255
...
tunnel destination 20.166.136.216
...
ip tcp adjust-mss 1350
tunnel source 10.30.1.9
tunnel destination 20.166.136.114
tunnel protection ipsec profile AZURE-IPSEC-PROFILE
!
interface Loopback0
