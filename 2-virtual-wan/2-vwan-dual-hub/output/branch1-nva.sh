...
peer 20.31.172.193
address 20.31.172.193
pre-shared-key changeme
peer 20.31.172.64
address 20.31.172.64
pre-shared-key changeme
peer 20.93.108.150
address 20.93.108.150
pre-shared-key changeme
peer 20.93.107.156
address 20.93.107.156
pre-shared-key changeme
!
crypto ikev2 profile AZURE-IKE-PROPOSAL
match address local 10.10.1.9
match identity remote address 20.31.172.193 255.255.255.255
match identity remote address 20.31.172.64 255.255.255.255
match identity remote address 20.93.108.150 255.255.255.255
match identity remote address 20.93.107.156 255.255.255.255
...
tunnel destination 20.31.172.193
...
ip tcp adjust-mss 1350
tunnel source 10.10.1.9
tunnel destination 20.31.172.64
tunnel protection ipsec profile AZURE-IPSEC-PROFILE
!
interface Tunnel2
...
ip tcp adjust-mss 1350
tunnel source 10.10.1.9
tunnel destination 20.93.108.150
tunnel protection ipsec profile AZURE-IPSEC-PROFILE
!
interface Tunnel3
...
ip tcp adjust-mss 1350
tunnel source 10.10.1.9
tunnel destination 20.93.107.156
tunnel protection ipsec profile AZURE-IPSEC-PROFILE
!
interface Loopback0
...
ip route 192.168.22.13 255.255.255.255 Tunnel2
ip route 192.168.22.12 255.255.255.255 Tunnel3
...
neighbor 192.168.22.13 route-map NEXT-HOP out
...
neighbor 192.168.22.12 route-map NEXT-HOP out
