...
peer 20.31.183.212
address 20.31.183.212
pre-shared-key changeme
!
crypto ikev2 profile AZURE-IKE-PROPOSAL
match address local 10.10.1.9
match identity remote address 20.4.89.0 255.255.255.255
match identity remote address 20.31.183.212 255.255.255.255
...
ip tcp adjust-mss 1350
tunnel source 10.10.1.9
tunnel destination 20.31.183.212
tunnel protection ipsec profile AZURE-IPSEC-PROFILE
!
interface Loopback0
