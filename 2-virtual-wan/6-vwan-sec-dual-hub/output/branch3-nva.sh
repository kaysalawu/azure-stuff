...
peer 51.104.152.138
address 51.104.152.138
pre-shared-key changeme
peer 51.104.157.3
address 51.104.157.3
pre-shared-key changeme
!
crypto ikev2 profile AZURE-IKE-PROPOSAL
match address local 10.30.1.9
match identity remote address 51.104.152.138 255.255.255.255
match identity remote address 51.104.157.3 255.255.255.255
...
tunnel destination 51.104.152.138
...
ip tcp adjust-mss 1350
tunnel source 10.30.1.9
tunnel destination 51.104.157.3
tunnel protection ipsec profile AZURE-IPSEC-PROFILE
!
interface Loopback0
