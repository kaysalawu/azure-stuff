...
peer 20.238.246.137
address 20.238.246.137
pre-shared-key changeme
peer 20.238.246.60
address 20.238.246.60
pre-shared-key changeme
!
crypto ikev2 profile AZURE-IKE-PROPOSAL
match address local 10.10.1.9
match identity remote address 20.238.246.137 255.255.255.255
match identity remote address 20.238.246.60 255.255.255.255
...
tunnel destination 20.238.246.137
...
ip tcp adjust-mss 1350
tunnel source 10.10.1.9
tunnel destination 20.238.246.60
tunnel protection ipsec profile AZURE-IPSEC-PROFILE
!
interface Loopback0
