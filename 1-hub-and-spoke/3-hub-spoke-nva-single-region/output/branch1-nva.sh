...
match address local 10.10.1.9
match identity remote address 20.73.138.118 255.255.255.255
match identity remote address 4.245.68.7 255.255.255.255
...
tunnel destination 20.73.138.118
