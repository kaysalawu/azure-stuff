...
peer 20.101.12.114
address 20.101.12.114
pre-shared-key changeme
!
crypto ikev2 profile AZURE-IKE-PROPOSAL
match address local 10.10.1.9
match identity remote address 20.101.15.9 255.255.255.255
match identity remote address 20.101.12.114 255.255.255.255
...
tunnel destination 20.101.15.9
...
ip tcp adjust-mss 1350
tunnel source 10.10.1.9
tunnel destination 20.101.12.114
tunnel protection ipsec profile AZURE-IPSEC-PROFILE
!
interface Loopback0
