...
resource "azurerm_virtual_network_peering" "spoke4_to_hub2_peering" {
  ...
  virtual_network_name         = module.spoke4.vnet.0.name
  remote_virtual_network_id    = module.hub2.vnet.0.id
...
resource "azurerm_virtual_network_peering" "hub2_to_spoke4_peering" {
  ...
  virtual_network_name         = module.hub2.vnet.0.name
  remote_virtual_network_id    = module.spoke4.vnet.0.id
  allow_virtual_network_access = true
  allow_forwarded_traffic      = true
...
resource "azurerm_virtual_network_peering" "spoke5_to_hub2_peering" {
  ...
  virtual_network_name         = module.spoke5.vnet.0.name
  remote_virtual_network_id    = module.hub2.vnet.0.id
  allow_virtual_network_access = true
  allow_forwarded_traffic      = true
  use_remote_gateways          = true
...
resource "azurerm_virtual_network_peering" "hub2_to_spoke5_peering" {
  ...
  virtual_network_name         = module.hub2.vnet.0.name
  remote_virtual_network_id    = module.spoke5.vnet.0.id
  allow_virtual_network_access = true
  allow_forwarded_traffic      = true
  allow_gateway_transit        = true
  depends_on = [
...
resource "azurerm_virtual_network_gateway_connection" "hub2_branch3_lng" {
  ...
  type                       = "IPsec"
  enable_bgp                 = true
  virtual_network_gateway_id = module.hub2.vpngw.0.id
...
resource "azurerm_route_server_bgp_connection" "hub2_ars_bgp_conn" {
  ...
  route_server_id = module.hub2.ars.0.id
