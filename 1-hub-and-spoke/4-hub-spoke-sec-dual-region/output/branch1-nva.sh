...
peer 20.13.54.150
address 20.13.54.150
pre-shared-key changeme
!
crypto ikev2 profile AZURE-IKE-PROPOSAL
match address local 10.10.1.9
match identity remote address 20.13.54.76 255.255.255.255
match identity remote address 20.13.54.150 255.255.255.255
...
tunnel destination 20.13.54.76
...
ip tcp adjust-mss 1350
tunnel source 10.10.1.9
tunnel destination 20.13.54.150
tunnel protection ipsec profile AZURE-IPSEC-PROFILE
!
interface Loopback0
...
ip route 10.1.0.0 255.255.255.0 10.10.2.1
!
!
router bgp 65001
