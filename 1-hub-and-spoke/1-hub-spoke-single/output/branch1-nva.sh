...
peer 20.4.107.178
address 20.4.107.178
pre-shared-key changeme
peer 20.4.107.202
address 20.4.107.202
pre-shared-key changeme
!
crypto ikev2 profile AZURE-IKE-PROPOSAL
match address local 10.10.1.9
match identity remote address 20.4.107.178 255.255.255.255
match identity remote address 20.4.107.202 255.255.255.255
...
tunnel destination 20.4.107.178
...
ip tcp adjust-mss 1350
tunnel source 10.10.1.9
tunnel destination 20.4.107.202
tunnel protection ipsec profile AZURE-IPSEC-PROFILE
!
interface Loopback0
